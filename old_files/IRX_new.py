...
for i in range(len(numbers)):
    ...
    yUVX = scattered_emission[UVrange]/(xUV/1e6)
    yintUVX = integrate.cumtrapz(yUVX, xUV)
    FIR = yintIRX[-1]
    FUV = yintUVX[-1]
    IRx = FIR/FUV
    ...
    plt.savefig('/oasis/scratch/comet/drenniks/temp_project/1945/figures/check_slope_' + str(numbers[i]) + '.png') 
    x = np.log10(xUV)
    y = np.log10(yUV)
    ...
    fig.savefig("/oasis/scratch/comet/drenniks/temp_project/1945/figures/line-time_" + str(numbers[i]) + ".png")
    fig.clf()
    ...
    fig.savefig("/oasis/scratch/comet/drenniks/temp_project/1945/figures/corner_" + str(numbers[i]) + ".png")
    fig.clf()
    ...
    fig.savefig("/oasis/scratch/comet/drenniks/temp_project/1945/figures/proj_results_" + str(numbers[i]) + ".png")
    fig.clf()
