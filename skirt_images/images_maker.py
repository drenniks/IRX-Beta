...
for i in range(len(numbers)):
    copyfile('RGB_wave_images_faceon.ski', 'RGB_wave_images_faceon_' +str(numbers[i])+ '.ski')
    for line in fileinput.input('RGB_wave_images_faceon_'+str(numbers[i])+'.ski', inplace=1):
    ...
    copyfile('RGB_wave_images_sideon.ski', 'RGB_wave_images_sideon_' +str(numbers[i])+ '.ski')
    for line in fileinput.input('RGB_wave_images_sideon_'+str(numbers[i])+'.ski', inplace=1):
        if 'stars_test_500_centered.dat' in line:
            line = line.replace('stars_test_500_centered.dat', 'stars_' +str(numbers[i])+ '.dat')
        sys.stdout.write(line)
        del line
    ...
    copyfile('IR_wave_images_faceon.ski', 'IR_wave_images_faceon_' +str(numbers[i])+ '.ski')
    for line in fileinput.input('IR_wave_images_faceon_'+str(numbers[i])+'.ski', inplace=1):
        if 'stars_test_500_centered.dat' in line:
            line = line.replace('stars_test_500_centered.dat', 'stars_' +str(numbers[i])+ '.dat')
        sys.stdout.write(line)
        del line
    ...
    copyfile('IR_wave_images_sideon.ski', 'IR_wave_images_sideon_' +str(numbers[i])+ '.ski')
    for line in fileinput.input('IR_wave_images_sideon_'+str(numbers[i])+'.ski', inplace=1):
        if 'stars_test_500_centered.dat' in line:
            line = line.replace('stars_test_500_centered.dat', 'stars_' +str(numbers[i])+ '.dat')
        sys.stdout.write(line)
        del line
